...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productos3 = new Producto("LAPTOP CCC \n"+
    ...
    String numeroTelefono="0983635338";
    String cod_Pais="593";
